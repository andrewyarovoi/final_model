...
def create_static_dataset(input_path, output_path, num_points=1024, sub_f="train"):
    ...
    num_files = count_number_of_files(root_dir, sub_f)
    ...
    for category in classes.keys():
        ...
        for file in os.listdir(file_dir):
            ...
            pointclouds[idx, :, :] = helpers.extract_pointcloud(cat_dir, file, helpers.static_transforms(num_points))
